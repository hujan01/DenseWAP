'''
Author: sigmoid
Description: 基于传统注意力模块的训练脚本
Email: 595495856@qq.com
Date: 2021-03-06 20:09:48
LastEditTime: 2021-03-06 20:09:48
'''
import math, time
import random
import os   
...
from model_v1 import Encoder, Decoder
...
for epoch in range(1, cfg.num_epoch+1):
    ...
    if (sacc > exprate):
        ...
        torch.save(encoder.state_dict(), 'checkpoints/encoder_classic.pkl')
        torch.save(decoder.state_dict(), 'checkpoints/attn_decoder_classic.pkl')
        print("done")
    else:
