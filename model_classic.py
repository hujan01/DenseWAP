'''
Author: sigmoid
Description: 使用传统注意力模块的序列解码器
Email: 595495856@qq.com
Date: 2021-03-06 19:40:07
LastEditTime: 2021-03-06 20:07:17
'''
import torch
...
class ClassicAttention(nn.Module):
    ...
    def forward(self, x, st_hat): 
        ...
        attention_score = torch.tanh(key + query[None, None, :, :])
...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        self.classic_attn = ClassicAttention(
            context_size,
    ...
    def reset(self, batch_size, feat_shape):
        self.classic_attn.reset_alpha(batch_size, feat_shape[2]*feat_shape[3])
    ...
    def forward(self, x, hidden, feature):
        ...
        context, decoder_attention = self.classic_attn(feature, pred)
